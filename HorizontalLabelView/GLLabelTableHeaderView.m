...
@interface GLLabelTableHeaderView ()<UICollectionViewDelegateFlowLayout,UICollectionViewDataSource>
...
@implementation GLLabelTableHeaderView
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    if ([self.delegate respondsToSelector:@selector(labelHeaderView:didSelected:)]) {
        [self.delegate labelHeaderView:self didSelected:indexPath.row];
    }
}

- (void)scrollViewDidScroll:(GLCollectionView *)scrollView{
    if ([self.delegate respondsToSelector:@selector(labelHeaderView:didScrollOffset:)]) {
        [self.delegate labelHeaderView:self didScrollOffset:scrollView.contentOffset];
    }
}
